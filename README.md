...
[3D model of the case](https://www.thingiverse.com/thing:6689722)
...
```
* The first param of the registration record is the address of the main plugin function `&plgSample`.
